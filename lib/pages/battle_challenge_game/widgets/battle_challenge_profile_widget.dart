...
class BattleChallengeProfileWidget extends StatelessWidget {
  const BattleChallengeProfileWidget({
    super.key,
    required this.isYou,
  ...
  final Map<String,dynamic> trackProgress;
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<BattleChallengeGameProvider>(
      builder:
          (context, provider, child) => Expanded(
            child: SizedBox(
              height: 140,
              child: Stack(
                children: [
                        ...
                        Stack(
                          children: [
                            CcProfileImageWidget(
                              size: 65,
                              avatar: player.avatar ?? 'AVT_001',
                              border: player.border ?? 'BD_001',
                            ),
                            Positioned(
                              bottom: 0,
                              right: isYou ? 0 : null,
                    ...
                    child: Positioned(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          color:
                              trackProgress["${provider.currentIndex}"] == 0
                                  ? Colors.grey.shade500
                                  : trackProgress["${provider.currentIndex}"] == 1
                                  ? successColor
                                  : errorColor,
                          boxShadow: const [
