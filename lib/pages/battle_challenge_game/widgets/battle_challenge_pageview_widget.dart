...
import 'package:flaguiz/pages/battle_challenge_game/widgets/battle_challenge_answer_widget.dart';
import 'package:flaguiz/pages/battle_challenge_game/widgets/battle_challenge_option_box_widget.dart';
import 'package:flaguiz/utils/enum/question_type.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class BattleChallengePageviewWidget extends StatefulWidget {
  const BattleChallengePageviewWidget(
      {super.key, required this.questions, required this.controller});
  final List<BattleQuestionModel> questions;
  final PageController controller;

  @override
  State<BattleChallengePageviewWidget> createState() =>
      _BattleChallengePageviewWidgetState();
}

class _BattleChallengePageviewWidgetState extends State<BattleChallengePageviewWidget> {
  @override
      ...
      builder: (context, provider, child) => Expanded(
        child: PageView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return Column(
              children: [
                BattleChallengeAnswerWidget(question: question),
                  ...
                  child: Column(
                    children: [
                      Row(
                        ...
                        children: [
                          BattleChallengeOptionBoxWidget(
