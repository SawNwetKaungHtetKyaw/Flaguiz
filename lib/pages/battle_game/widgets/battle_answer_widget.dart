...
class BattleAnswerWidget extends StatelessWidget {
  const BattleAnswerWidget({super.key, required this.question});
  ...
  Widget build(BuildContext context) {
    ...
    return Expanded(child: Center(child: returnWidget()));
  }
}
